...
* **O que você aprendeu para aplicar em problemas futuros:** Aprendi a **estruturar corretamente classes** em Orientação a Objetos, a aplicar **encapsulamento**, a reutilizar códigos por meio de **herança** e a utilizar **polimorfismo** com arrays de ponteiros da classe base para otimizar a execução de métodos sobrescritos.
